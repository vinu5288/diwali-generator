document.addEventListener("DOMContentLoaded", () => {
  ...
  const templatePrompts = {
    ...
    "C-05": "Ultra-realistic portrait of an Indian couple outdoors at night celebrating Diwali with sparklers. Use the reference image to preserve the woman’s face exactly. Both look directly at the camera, smiling broadly, radiating festive excitement. She wears orange silk saree with golden embroidery, hair in soft curls. He wears navy blue kurta, standing close beside her, holding a sparkler. Background: night sky with blurred fireworks, festive lights, and a metallic “HAPPY DIWALI” text glowing behind them. Cinematic lens, 8K resolution, soft warm volumetric glow, vibrant joyful Diwali vibe. Critical: Both faces, especially the woman, must match 100% with the reference images provided. Avoid changing identity, facial features, or expression. Use the reference image strictly for facial likeness."
  };
